...
# NOTE: We only setup the signal for the
# Redirect model if the requisite app is installed.
# This ensures we avoid errors at startup for projects
...
if 'django.contrib.redirects' in settings.INSTALLED_APPS:
    ...
    def clear_redirect_cache(sender, instance, **kwargs):
        ...
        """
        cache_key = \
            f'{settings.REDIRECT_CACHE_KEY_PREFIX}-{instance.site.domain}'
